...
local hash = loadstring(downloadFile('BDTestCheat/libraries/hash.lua'), 'hash')()
local prediction = loadstring(downloadFile('BDTestCheat/libraries/prediction.lua'), 'prediction')()
entitylib = loadstring(downloadFile('BDTestCheat/libraries/entity.lua'), 'entitylibrary')()
local whitelist = {
	alreadychecked = {},
	customtags = {},
...
run(function()
	...
	function whitelist:update(first)
		...
		if not first or whitelist.textdata ~= whitelist.olddata then
			if not first then
				whitelist.olddata = isfile('BDTestCheat/profiles/whitelist.json') and readfile('BDTestCheat/profiles/whitelist.json') or nil
			end
			...
			if whitelist.textdata ~= whitelist.olddata then
				...
				pcall(function()
					writefile('BDTestCheat/profiles/whitelist.json', whitelist.textdata)
				end)
			end
...
run(function()
	...
	local function Added(ent)
		...
		arrow.Visible = false
		arrow.Image = getcustomasset('BDTestCheat/assets/new/arrowmodule.png')
...
run(function()
	...
	Radar = vape:CreateOverlay({
		Name = 'Radar',
		Icon = getcustomasset('BDTestCheat/assets/new/radaricon.png'),
