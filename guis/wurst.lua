...
local getcustomassets = {
	['BDTestCheat/assets/wurst/triangle.png'] = 'rbxasset://wurst/triangle.png'
}
...
local function downloadFile(path, func)
	if not isfile(path) then
		local suc, res = pcall(function() return game:HttpGet('https://raw.githubusercontent.com/Divulgate/BDTestCheat/'..readfile('BDTestCheat/profiles/commit.txt')..'/'..select(1, path:gsub('BDTestCheat/', '')), true) end)
...
function mainapi:CreateCategory(categorysettings)
	...
	function categoryapi:CreateModule(modulesettings)
		...
		triangle.Image = getcustomasset('BDTestCheat/assets/wurst/triangle.png')
